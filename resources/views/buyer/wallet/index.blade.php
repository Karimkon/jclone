        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Wallet Balance</h2>
                </div>
                
                <div class="text-center mb-6">
                    <div class="text-5xl font-bold text-primary mb-2">${{ number_format($wallet->balance, 2) }}</div>
                    <p class="text-gray-600">Available Balance</p>
                    
                    @if($wallet->locked_balance > 0)
                    <div class="mt-4">
                        <p class="text-sm text-gray-600">Locked Balance: ${{ number_format($wallet->locked_balance, 2) }}</p>
                        <p class="text-xs text-gray-500">(Pending withdrawals or holds)</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="space-y-3">
                    <button onclick="openDepositModal()" 
                            class="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition">
                        <i class="fas fa-plus mr-2"></i> Add Funds
                    </button>
                    
                    <button onclick="openWithdrawModal()" 
                            class="w-full border border-primary text-primary py-3 rounded-lg font-semibold hover:bg-primary hover:text-white transition">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Reference: {{ $transaction->reference }}</p>
                                @endif
                            </div>
                            
                            <div class="text-right">
                                <div class="font-bold text-lg @if($transaction->amount > 0) text-green-600 @else text-red-600 @endif">
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500">Your wallet transaction history will appear here</p>
                    <button onclick="openDepositModal()" 
                            class="mt-4 inline-flex items-center px-6 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-indigo-700 transition">
