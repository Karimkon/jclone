                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="audience" id="audience" required
                            ...
                            <option value="custom" {{ old('audience', $campaign->audience) === 'custom' ? 'selected' : '' }}>Custom Selection</option>
                        </select>
                    </div>

                    <!-- Custom Filters -->
                    @php $savedRoles = old('filters.roles', $campaign->filters['roles'] ?? []); @endphp
                    <div id="customFilters" class="{{ old('audience', $campaign->audience) === 'custom' ? '' : 'hidden' }} bg-gray-50 rounded-lg p-4">
